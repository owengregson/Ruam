...
(() => {
  ...
  var __webpack_modules__ = ({
    "./src/pipeline.ts"(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      class DifficultyAnalyzer {
        analyze(text) { return text.split('').map(() => Math.random()); }
      }
  ...
  console.log("pipeline works:", pipeline.stages[0].name === "DifficultyStage");
})();
